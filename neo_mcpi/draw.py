# from Minecraft stuff - integrated here!
...
try:
    import neo_mcpi.minecraft as minecraft
    import neo_mcpi.block as block
    import neo_mcpi.util as util
except ImportError:
    import minecraft
    import block
    import util
...
class MinecraftDrawing:
    ...
    def drawPoint3d(self, x, y, z, blockType: int, blockData: int = 0):
        """
    ...
    def drawFace(self, vertices: list, filled: bool, blockType: int, blockData: int = 0):
        """
        ...
        if isinstance(vertices, Points):
            vertices: list = vertices.getVec3s()
        ...
        if filled:
            ...
            def keyX(point: minecraft.Vec3) -> int:
                return point.x

            def keyY(point: minecraft.Vec3) -> int:
                return point.y

            def keyZ(point: minecraft.Vec3) -> int:
                return point.z
    ...
    def drawVertices(self, vertices: list, blockType: int, blockData: int = 0):
        """
