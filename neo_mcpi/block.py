def add_minecraft(name: str):
    return f"minecraft:{name}" if not name.startswith("minecraft:") else name


def get_block_name(id: "int | Block") -> str:
...
class Block:
    ...
    def __init__(self, id: int | str, data: int | None = 0):
        self.id = id
        self.data = data
...
BLOCKS['LAVA'] = BLOCKS['LAVA_FLOWING']
BLOCKS['BEDROCK_INVISIBLE'] = BLOCKS['STAINED_GLASS']
